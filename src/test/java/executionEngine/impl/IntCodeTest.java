...
public class IntCodeTest {
    ...
    public void shouldHaltImmediatelyWhenOpCodeIs99() {
        assertArrayEquals(
          new int[]{99},
          new IntCode(99).execute(new Input())
        );
    }
    ...
    public void shouldReturn2_0_0_0_99WhenOpCodeIs1_0_0_0_99() {
        assertArrayEquals(
          new int[]{2,0,0,0,99},
          new IntCode(1,0,0,0,99).execute(new Input())
        );
    }
    ...
    public void shouldReturn2_0_0_6_99WhenOpCodeIs2_3_0_3_99() {
        assertArrayEquals(
          new int[]{2,3,0,6,99},
          new IntCode(2,3,0,3,99).execute(new Input())
        );
    }
    ...
    public void shouldReturn2_4_4_5_99_9801WhenOpCodeIs2_4_4_5_99_0() {
        assertArrayEquals(
          ...
          new IntCode(2,4,4,5,99,0).execute(new Input())
        );
    }
    ...
    public void shouldReturnCorrectValueWhenOpCodeIs() {
        ...
        assertArrayEquals(
          expected,
          new IntCode(opCodes).execute(new Input())
        );
    }
    ...
    public void printProperValueForPuzzle() {
        ...
        System.out.println(Arrays.toString(new IntCode(opCodes).execute(new Input())));
    ...
    private int[] calucalateRequiredInputs(int[] opCodes) {
        for (int i = 0; i <100 ; i++) {
            for (int j = 0; j < 100; j++) {
                ...
                newOpCodes[1]=i;
                newOpCodes[2]=j;
                final int[] result = new IntCode(newOpCodes).execute(new Input());
