...
public class IntCodeTestOutput {
    ...
    public void shouldReturnOneWhenInputIs8() {
        ...
        expectProgramOutputToBe(1, intCode,8);
    }

    @Test
    public void shouldReturnOneWhenInputIs8UsingImmediate() {
        final IntCode intCode = new IntCode( 3,3,1108,-1,8,3,4,3,99);
        expectProgramOutputToBe(1, intCode, 8);
    }


    @Test
    public void shouldPrintDay5Test2(){
