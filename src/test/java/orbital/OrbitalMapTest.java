...
public class OrbitalMapTest {
    ...
    public void shoulParseMap() {
        final OrbitalMap orbitalMap = OrbitalMap.parse("COM)B\n" +
          "B)C\n" +
          "C)D\n" +
          "D)E\n" +
          "E)F\n" +
        ...
        assertEquals(11, orbitalMap.getCOM().getTotal());
    ...
    @Test
    public void showPuzzleDay61() {
        final OrbitalMap orbitalMap = OrbitalMap.parse("P1T)TR7\n" +
          "3NS)SL6\n" +
          "JMH)MLH\n" +
          "K57)Z9Q\n" +
          "F4G)TCS\n" +
