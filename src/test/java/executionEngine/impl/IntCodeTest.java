...
public class IntCodeTest {
    ...
    public void shouldReturnCorrectValueWhenOpCodeIs() {
        final long[] expected = {30,1,1,4,2,5,6,0,99};
        final long[] opCodes = {1,1,1,4,99,5,6,0,99};
    ...
    public void printProperValueForPuzzle() {
        final long[] opCodes = {1,12,2,3,1,1,2,3,1,3,4,3,1,5,0,3,2,6,1,19,1,19,5,23,2,10,23,27,2,27,13,31,1,10,31,35,1,35,9,39,2,39,13,43,1,43,5,47,1,47,6,51,2,6,51,55,1,5,55,59,2,9,59,63,2,6,63,67,1,13,67,71,1,9,71,75,2,13,75,79,1,79,10,83,2,83,9,87,1,5,87,91,2,91,6,95,2,13,95,99,1,99,5,103,1,103,2,107,1,107,10,0,99,2,0,14,0};
    ...
    public void printInputsAndAnsForLoc1AndLoc2For19690720AtPositon0Puzzle() {
        ...
        final long[] res = calucalateRequiredInputs(opCodes);

        System.out.println(Arrays.toString(res));
        final long x = 100 * res[0] + res[1];
    ...
    private long[] calucalateRequiredInputs(long[] opCodes) {
        for (int i = 0; i <100 ; i++) {
            for (int j = 0; j < 100; j++) {
                final long[] newOpCodes = Arrays.copyOf(opCodes, opCodes.length);
                newOpCodes[1]=i;
                newOpCodes[2]=j;
                final IntCode intCode = new IntCode(newOpCodes);
                intCode.execute();
                final long[] result = intCode.getWorkingMemory();
    ...
    public void shouldPrintDay5Test(){
        ...
        assertEquals(asList(0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 16574641L),intCodeExecutor.getOutputsAsList());
    }
}